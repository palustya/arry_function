...
if (isset($_POST['submit'])) {
    ...
    if (empty($name) || empty($lastname) || empty($address) || empty($email) || empty($mobileno)) {
        ...
        // Assuming 'insert' is a function to insert data into the database
        // You might need to replace 'demo' with your actual table name
        insert('demo', $insert);
    ...
    // Display the data in the table by default
